...
const TransactionIsolation: $TransactionIsolation = $.makeType<$TransactionIsolation>(_.spec, "fad74df8-00ce-11ee-b14d-37b5872d6037", _.syntax.literal);
...
const VersionStage: $VersionStage = $.makeType<$VersionStage>(_.spec, "fad7b478-00ce-11ee-8f6a-b399c8e7e5f7", _.syntax.literal);

export type $SystemObjectλShape = $.typeutil.flatten<_schema.$Object_f6a2efd000ce11eebcd68fb1bad207a0λShape & {
}>;
type $SystemObject = $.ObjectType<"sys::SystemObject", $SystemObjectλShape, null, [
  ..._schema.$Object_f6a2efd000ce11eebcd68fb1bad207a0['__exclusives__'],
]>;
const $SystemObject = $.makeType<$SystemObject>(_.spec, "fad81936-00ce-11ee-938b-6f0e269822b6", _.syntax.literal);
...
const $ExternalObject = $.makeType<$ExternalObject>(_.spec, "fae255c2-00ce-11ee-a357-216fac507eb4", _.syntax.literal);
...
const $Database = $.makeType<$Database>(_.spec, "faec9e6a-00ce-11ee-8dfb-198ae83511a5", _.syntax.literal);
...
const $ExtensionPackage = $.makeType<$ExtensionPackage>(_.spec, "faff4d80-00ce-11ee-b86d-f1043a4b6a59", _.syntax.literal);
...
const $Role = $.makeType<$Role>(_.spec, "fb158c1c-00ce-11ee-9686-e593693c7533", _.syntax.literal);
...
function get_version(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_version', args, _.spec, [
    {args: [], returnTypeId: "fb021718-00ce-11ee-8d81-5d6f603eab62"},
  ]);
...
function get_transaction_isolation(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_transaction_isolation', args, _.spec, [
    {args: [], returnTypeId: "fad74df8-00ce-11ee-b14d-37b5872d6037"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
