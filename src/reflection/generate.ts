...
export async function generateQB(params: {
  ...
  throw new Error(
    \`querybuilder was generated by a different version of edgedb-js (v${_edgedbJsVersion})\` +
      \` than currently installed version of edgedb-js (v\${_edgedbJsVersion}).\\n\` +
      \`Re-run 'npm edgeql-js' to update the querybuilder.\\n\`
  );
}`,
    ]);
