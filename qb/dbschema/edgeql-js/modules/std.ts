...
const $anyscalar: $anyscalar = $.makeType<$anyscalar>(_.spec, "73795da2-77f8-11ec-a0fb-95758a2ed256", _.syntax.literal);
...
const $anyreal: $anyreal = $.makeType<$anyreal>(_.spec, "737f608a-77f8-11ec-b80e-79da670d9616", _.syntax.literal);

type $anyfloat = $number;
const $anyfloat: $anyfloat = $.makeType<$anyfloat>(_.spec, "73833b92-77f8-11ec-ba18-a953df212644", _.syntax.literal);

type $anyint = $number | $bigint;
const $anyint: $anyint = $.makeType<$anyint>(_.spec, "73802e5c-77f8-11ec-bb71-d5cd789ef564", _.syntax.literal);

type $anynumeric = $decimal | $bigint;
const $anynumeric: $anynumeric = $.makeType<$anynumeric>(_.spec, "738575f6-77f8-11ec-8118-c31d6ebbaa16", _.syntax.literal);
...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "7387c356-77f8-11ec-a2f8-3ffa01fdc573", _.syntax.literal);
...
const $BaseObject = $.makeType<$BaseObject>(_.spec, "7afe0046-77f8-11ec-8427-71ef12be3838", _.syntax.literal);
...
export type $Object_7b057b6477f811ec8deb1f5fc25e7818λShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_7b057b6477f811ec8deb1f5fc25e7818 = $.ObjectType<"std::Object", $Object_7b057b6477f811ec8deb1f5fc25e7818λShape, null>;
const $Object_7b057b6477f811ec8deb1f5fc25e7818 = $.makeType<$Object_7b057b6477f811ec8deb1f5fc25e7818>(_.spec, "7b057b64-77f8-11ec-8deb-1f5fc25e7818", _.syntax.literal);

const Object_7b057b6477f811ec8deb1f5fc25e7818: $.$expr_PathNode<$.TypeSet<$Object_7b057b6477f811ec8deb1f5fc25e7818, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Object_7b057b6477f811ec8deb1f5fc25e7818, $.Cardinality.Many), null, true);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "7b0d993e-77f8-11ec-ab20-7985420ab019", _.syntax.literal);
...
function min(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "737f608a-77f8-11ec-b80e-79da670d9616", optional: false, setoftype: true, variadic: false}], returnTypeId: "737f608a-77f8-11ec-b80e-79da670d9616", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "73888fe8-77f8-11ec-9a80-4de755fc7ccd", optional: false, setoftype: true, variadic: false}], returnTypeId: "73888fe8-77f8-11ec-9a80-4de755fc7ccd", returnTypemod: "OptionalType", preservesOptionality: true},
...
function sequence_reset(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "7f025b2e-77f8-11ec-be4f-f1dd71625fc0", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "7f025b2e-77f8-11ec-be4f-f1dd71625fc0", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { $anyscalar, str, $anyreal, $anyfloat, $anyint, $anynumeric, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, uuid, number, $BaseObject, BaseObject, $Object_7b057b6477f811ec8deb1f5fc25e7818, Object_7b057b6477f811ec8deb1f5fc25e7818, $FreeObject, FreeObject };
...
type __defaultExports = {
  ...
  "Object": typeof Object_7b057b6477f811ec8deb1f5fc25e7818;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_7b057b6477f811ec8deb1f5fc25e7818,
