...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$_b5016c1606ef11edb2bb3bd5ba8089d5 ? _default.$_b5016c1606ef11edb2bb3bd5ba8089d5 : 
  T extends _default.$_b4ff9ba206ef11eda116455b6f373ff5 ? _default.$_b4ff9ba206ef11eda116455b6f373ff5 : 
  T extends _default.$_b4ff8afe06ef11ed8f6f31e9ef5bff4c ? _default.$_b4ff8afe06ef11ed8f6f31e9ef5bff4c : 
  T extends _default.$str_required_multi ? _default.$str_required_multi : 
  T extends _default.$str_multi ? _default.$str_multi : 
  T extends _std.$str ? _std.$str : 
  T extends _default.$global_seq ? _default.$global_seq : 
  T extends _default.$bag_seq ? _default.$bag_seq : 
  T extends _std.$int64 ? _std.$int64 : 
  T extends _default.$Genre ? _default.$Genre : 
  T extends _cfg.$memory ? _cfg.$memory : 
  T extends _cfg.$TestEnum ? _cfg.$TestEnum : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _schema.$AccessKind ?
    ...
    never
  :
  A extends _default.$_b5016c1606ef11edb2bb3bd5ba8089d5 ?
    B extends _default.$_b5016c1606ef11edb2bb3bd5ba8089d5 ?
    B
    :
    never
  :
  A extends _default.$_b4ff9ba206ef11eda116455b6f373ff5 ?
    B extends _default.$_b4ff9ba206ef11eda116455b6f373ff5 ?
    B
    :
    never
  :
  A extends _default.$_b4ff8afe06ef11ed8f6f31e9ef5bff4c ?
    B extends _default.$_b4ff8afe06ef11ed8f6f31e9ef5bff4c ?
    B
    :
    never
  :
  A extends _default.$str_required_multi ?
    B extends _default.$str_required_multi ?
    B
    :
    never
  :
  A extends _default.$str_multi ?
    B extends _default.$str_multi ?
    B
    :
    never
  :
  A extends _std.$str ?
    ...
    never
  :
  A extends _default.$global_seq ?
    B extends _default.$global_seq ?
    B
    :
    never
  :
  A extends _default.$bag_seq ?
    B extends _default.$bag_seq ?
    B
    :
    never
  :
  A extends _std.$int64 ?
    ...
    never
  :
  A extends _default.$Genre ?
    B extends _default.$Genre ?
    B
    :
    never
  :
  A extends _cfg.$memory ?
    ...
    never
  :
  A extends _cfg.$TestEnum ?
    B extends _cfg.$TestEnum ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::str_required_multi") {
    if(b.__name__ === "default::str_required_multi") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::str_multi") {
    if(b.__name__ === "default::str_multi") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  ...
  if (a.__name__ === "default::global_seq") {
    if(b.__name__ === "default::global_seq") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::bag_seq") {
    if(b.__name__ === "default::bag_seq") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  ...
  if (a.__name__ === "default::Genre") {
    if(b.__name__ === "default::Genre") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  ...
  if (a.__name__ === "cfg::TestEnum") {
    if(b.__name__ === "cfg::TestEnum") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
